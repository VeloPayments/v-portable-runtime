/**
 * \file fail_dynamic_array_options_init_ex_nullcompare.c
 *
 * A null comparison method trips the model checker.
 *
...
int main(int argc, char* argv[])
{
    ...
    dynamic_array_options_init_ex(
        &options, &alloc_opts, sz, ctx, &my_copy, &my_dispose, NULL);
