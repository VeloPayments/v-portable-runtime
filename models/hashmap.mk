...
ALL:
	...
	--trace --stop-on-fail \
	--object-bits 16 --unwind 2 --unwindset __builtin___memset_chk.0:60,memcpy.0:10 \
	...
	../src/doubly_linked_list/doubly_linked_list_options_init_shadow.c \
	...
	../src/doubly_linked_list/doubly_linked_list_remove_shadow.c \
