/**
 * \file linked_list_options_init.c
 *
 * Implementation of linked_list_options_init.
 *
...
static void ll_simple_elem_copy(void*, const void*, size_t);
static void ll_simple_elem_dispose(allocator_options_t*, void*);
    ...
    bool copy_on_insert, size_t element_size, bool release_on_dispose)
{
    ...
    //initialize this structure in terms of linked_list_options_init_ex
    return linked_list_options_init_ex(options, alloc_opts,
        copy_on_insert ? &ll_simple_elem_copy : NULL,
        element_size,
        (copy_on_insert || release_on_dispose) ? ll_simple_elem_dispose
                                               : NULL);
}
 ...
 */
static void ll_simple_elem_copy(void* destination, const void* source, size_t size)
{
 ...
 */
static void ll_simple_elem_dispose(allocator_options_t* alloc_opts, void* elem)
{
    MODEL_ASSERT(NULL != alloc_opts);
